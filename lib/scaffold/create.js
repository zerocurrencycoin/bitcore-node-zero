...
var BASE_PACKAGE = {
  description: 'A full Zero node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zero': 'ProphetAlgorithms/bitcore-lib-zero',
    'bitcore-node-zero': 'ProphetAlgorithms/bitcore-node-zero'
  }
};
